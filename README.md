...
数据库MySQL8.0.33；
前台http://localhost/
后台http://localhost/login.html

### 使用的技术

本项目核心技术采用Spring Boot+Mybatis；开发工具idea；数据库MySQL；模版引擎采用的是Thymeleaf；安全框架采用Shiro，实现了完整权限系统，Controller方法采用Shiro注解来实现有效的权限控制；前台界面采用了Bootstrap技术；后台界面采用了EasyUI技术；
...
![image-20230531152117763](../../Library/Application Support/typora-user-images/image-20230531152117763.png)

##### 客户登录界面

![image-20230531152158952](../../Library/Application Support/typora-user-images/image-20230531152158952.png)

##### 客户注册页面

![image-20230531152233396](../../Library/Application Support/typora-user-images/image-20230531152233396.png)

##### 医院商城首页

![image-20230531152410544](../../Library/Application Support/typora-user-images/image-20230531152410544.png)

##### 查看商品详情

![image-20230531172038845](../../Library/Application Support/typora-user-images/image-20230531172038845.png)

##### 购物车

![image-20230531172356037](../../Library/Application Support/typora-user-images/image-20230531172356037.png)

##### 预约医生

![image-20230531172611771](../../Library/Application Support/typora-user-images/image-20230531172611771.png)

#### 后台

##### 后台页面

![image-20230531173736659](../../Library/Application Support/typora-user-images/image-20230531173736659.png)
